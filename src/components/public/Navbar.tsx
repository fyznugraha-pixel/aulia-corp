    ...
    <header className="sticky top-0 z-50 bg-background border-b border-on-surface/10 transition-all duration-200">
      ...
      {isOpen && (
        <div className="lg:hidden absolute top-full left-0 w-full bg-surface-container border-b border-outline-variant/20 shadow-xl flex flex-col py-4 px-6 gap-4">
          ...
          <Link href="/#about" onClick={closeMenu} className="font-label-lg text-on-background hover:text-tertiary py-2 border-b border-outline-variant/10">About</Link>
          <Link href="/#services" onClick={closeMenu} className="font-label-lg text-on-background hover:text-tertiary py-2 border-b border-outline-variant/10">Services</Link>
          <Link href="/#portfolio" onClick={closeMenu} className="font-label-lg text-on-background hover:text-tertiary py-2 border-b border-outline-variant/10">Portfolio</Link>
          <Link href="/#team" onClick={closeMenu} className="font-label-lg text-on-background hover:text-tertiary py-2 border-b border-outline-variant/10">Team</Link>
          <Link href="/#clients" onClick={closeMenu} className="font-label-lg text-on-background hover:text-tertiary py-2 border-b border-outline-variant/10">Clients</Link>
          <a 
            href="/#contact" 
            onClick={closeMenu}
